...
export default function LoginPage() {
  ...
  return (
    <div style={{minHeight:"100vh",background:"#0B0D10",color:"#F0F0F2",fontFamily:"'DM Sans',sans-serif",display:"flex",flexDirection:"column"}}>
      ...
      <div style={{position:"relative",zIndex:1,textAlign:"center",padding:20,fontSize:11,color:"#333",borderTop:"1px solid #1E2028"}}><Logo height={28} style={{opacity:0.4,marginBottom:8}} /><div>{"© 2026 VirtualBet Pro. 18+ Only."}</div></div>
    </div>
  );
}
