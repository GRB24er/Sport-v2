...
async function seed() {
  ...
  await db.collection("settings").insertOne({
    ...
    momoEnabled: true,
    momoProviders: [
      { id: "momo_main", name: "Mobile Money", number: "0598543640", accountName: "Flopat/Patience Ansah", color: "#0B9635", enabled: true },
    ],
    cryptoEnabled: true,
    usdtTrc20Address: "TCv8cnB6d1xsugzEYJyfhsduK8VeAiWytH",
    btcAddress: "bc1qmzvf7u6c67e3mx3ghzyxn7ljzh8f5g7jvgtenh",
    cardEnabled: false,
    whatsappNumber: "",
